    ...
    for y in range(2020, 2025):
        for m in range(1, 13):
            ...
            for d in range(1, days + 1):
                Visitor.create(date=date(y, m, d),
                               male=random.randrange(300, 1500, 1),
                               female=random.randrange(300, 1500, 1),
                               boy=random.randrange(300, 1500, 1),
                               girl=random.randrange(300, 1500, 1))
